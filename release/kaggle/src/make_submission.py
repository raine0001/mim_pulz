...
CANONICAL_RERANKER_MODELS: dict[str, Path] = {
    "seed42": PATHS.root / "artifacts" / "reranker_seed43.json",
    "seed43": PATHS.root / "artifacts" / "reranker_seed43.json",
    "seed44": PATHS.root / "artifacts" / "reranker_seed44.json",
}
...
def _profile_config(memory_profile: str, repo_root: Path) -> RetrievalConfig:
    ...
    if memory_profile == "oracc_best":
        return RetrievalConfig(
            ...
            domain_margin=0.02,
            external_memory_paths=(str((repo_root / "artifacts" / "oracc_memory.csv").resolve()),),
